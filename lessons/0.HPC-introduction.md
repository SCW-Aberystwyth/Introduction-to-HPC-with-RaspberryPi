...
instead, it is loaded into your environment incrementally using the Lmod module system. And it's
pretty easy to use:
...
or lab folder for bleeding-edge releases, software you are testing out, or software used
...
(Note: due to demand and the complex nature of software installs, it may take 1 to 2 
